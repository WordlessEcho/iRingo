...
async function outputData(api, now, obs, data, Settings) {
	...
	if (api == "v1") {
		...
		// weather.airQuality.metadata.providerLogo = `https://s2.loli.net/2022/04/20/VNCI5bXqAd9UKQe.png`;
		weather.airQuality.metadata.providerLogo = `https://s2.loli.net/2022/04/20/zvCB8VjyENHcgMq.png`;
